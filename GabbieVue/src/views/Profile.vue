<template>
  <div class="p-4 space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      <div class="p-4 flex items-center justify-between border-b border-gray-50 cursor-pointer active:bg-gray-50" @click="alert('Feature coming soon')">
      ...
      <div class="p-4 flex items-center justify-between border-b border-gray-50 cursor-pointer active:bg-gray-50" @click="alert('Feature coming soon')">
        ...
        <div class="relative w-10 h-6 bg-gray-200 rounded-full transition-colors">
          <div class="absolute top-1 left-1 bg-white w-4 h-4 rounded-full shadow-sm"></div>
        </div>
      </div>

      <div class="p-4 flex items-center justify-between cursor-pointer active:bg-gray-50" @click="resetData">
        <div class="flex items-center gap-3">
          <div class="w-8 h-8 rounded-full bg-red-50 flex items-center justify-center text-red-500">
            <i class="ph-fill ph-trash"></i>
          </div>
          <span class="font-medium text-red-600">Reset Data</span>
        </div>
      </div>
    </div>
